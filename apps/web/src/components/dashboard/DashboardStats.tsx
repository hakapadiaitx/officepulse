import { Users, UserX, Clock, UserCheck, Home, CalendarDays } from "lucide-react";
...
export function DashboardStats({ totalEmployees, inCount, outCount, notArrivedCount, leftCount, onLeaveCount, todayMinutes }: Props) {
  const stats = [
